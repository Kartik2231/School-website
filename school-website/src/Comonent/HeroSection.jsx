    ...
    return (
        <>
            ...
            <div class="hero-section">
                {/* <!-- hero section code started here --> */}
                    ...
                    <div class="container">
                        ...
                        <nav class="nav" id="nav">
                            <ul>
                                ...
                                <a href="athletic.html">Athletic</a>
            ...
            <div class="donation-container">
                <div class="clock-tower-img">
                    <div class="quick-link">
                        <div class="link">
                            <i class="icon-link" style="color:#ffffff;"></i>
                            <h3>Quick Links</h3>
                        </div>
                ...
                <div class="subscribe-news-letter">
                    <div class="envelop-img">
                        <img src="/images/envelope.png" alt="envelope" />
                    </div>
                    <div class="subscribe-content">
                        <h3>Subscribe To Newsletter</h3>
                        <h4>Get updates to news & events</h4>
                        <p>The Campaign for the Kingster University is the largest fundraising campaign in history. With a
                            historic</p>
                ...
                <div class="help-for-donation">
                    <div class="academic-students">
                        <img src="/images/donor-600x320.jpg" alt="donor-600x320" />
                    </div>
                    <h3>Donation helps us</h3>
                    <p>The Campaign for the Kingster University is the <strong>largest fundraising campaign in history.</strong>
                        With a historic
                        $1 billion goal, the campaign is expanding U of T’s global leadership capacity.</p>
                    <div class="become-a-door-btn">
            ...
            <footer class="footer">
                <div class="footer-container">
                    <div class="logo-content">
                        <img src="/images/logo-kindergarten.png" alt="logo-kindergarten" />
                        <div class="box35300">
                            <ul>
                                <li>Box 35300</li>
                    ...
                    <div class="Academis">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Pay My Tution</a></li>
                        </ul>
                    </div>
                </div>

                <div class="copy-right-container">
                    <div class="copy-right-p-content">
                        <p>Copyright All Right Reserved 2026, GoodLayers</p>
                    </div>
                    <div class="icons">
                        <svg fill="blue" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="blue">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path
                        ...
                        <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" fill="blue" stroke="blue">
                            <g id="SVGRepo_bluegCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Dribluebluebluele-Light-Preview" transform="translate(-220.000000, -7439.000000)"
                                        fill="blue">
